...
package com.rtmdn.exam.wsd.mapadapter.adapter;
...
import com.rtmdn.exam.wsd.mapadapter.MyMapEntryType;
import com.rtmdn.exam.wsd.mapadapter.MyMapType;

public final class MyMapAdapter extends XmlAdapter<MyMapType, Map<Integer, String>>
{
	@Override
